...
async def start_(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg",
        caption=f"""**━━━━━━━━━━━━━━━━━━━━━━━━
...
┣★ ⚡𝑂𝑤𝑛𝑒𝑟⚡  : [BLACK MAMBA](https://t.me/BLACKMAMBA_OFFICIAL)
┗━━━━━━━━━━━━━━━━━┛
━━━━━━━━━━━━━━━━━━━━━━━━**""",
...
@Client.on_message(commandpro(["/start", "/alive", "MAMZACKOMUSIC"]) & filters.group & ~filters.edited)
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "⚡𝗖𝗵𝗮𝗻𝗻𝗲𝗹⚡", url=f"https://t.me/MAMBA_NETWORK")
                ]
            ]
        ),
    )
